<?php
	...
	function hitung_tagihan_awal($jumlah, $harga){
		$tagihanAwal=$harga*$jumlah; //Nilai tagihan awal didapatkan dari harga dikalikan dengan jumlah.
		
		return $tagihanAwal; //Fungsi mengembalikan nilai tagihan awal.
	}

	//	Instruksi Kerja Nomor 2.
	//	Variabel $cabang berisi data kota lokasi cabang restoran dalam bentuk array.
		$cabang = array("Harmoni", "Sarinah", "Grogol", "Senayan", "Pluit", 
		"Cempaka");
	
	//	Instruksi Kerja Nomor 3.
	//	Mengurutkan array $cabang sesuai abjad A-Z.
	//  Mengurutkan array $cabang dengan fgungsi bawaan php sort()
		$cabangSorted = sort($cabang);

	//	Instruksi Kerja Nomor 4.
	//	Variabel untuk menyimpan harga satuan nasi kotak.
	//  Menyimpan harga satuan kedalam variabel $hargaSatuan
		$hargaSatuan = 50000;
?>
...
<html>
	...
	<div class="container border">
		...
		<!-- ..... -->
		<img src="img/logo.png" alt="Logo Resto">
		<!-- Form untuk memasukkan data pemesanan. -->
		<form action="index.php" method="post" id="formPemesanan">
			<div class="row">
			<!-- Instruksi Kerja Nomor 7. -->
			<!-- Menampilkan isi array pada instruksi kerja nomor 2 sebagai pilihan (dropdown) lokasi 
			cabang restoran pada form pemesanan dengan menggunakan kontrol perulangan. -->
				...
				<div class="col-lg-2">
					...
					<?php
						//Kontrol perulangan menggunakan foreach
	...
	<?php
		...
		if(isset($_POST['Pesan'])) {
			...
			//	Menghitung diskon.
			if ($tagihanAwal>=1000000) { //kondisional untuk menghitung diskon
				# code...
